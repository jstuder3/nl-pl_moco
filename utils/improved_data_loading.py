...
def generateDataLoader(language, split, tokenizer, args, batch_size=1, shuffle=False, augment=False, num_workers=0):
    ...
    if hasattr(args, "use_hard_negatives") and args.use_hard_negatives and split=="train": # ugly af
